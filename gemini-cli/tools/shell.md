[Skip to content](https://gemini-cli.xyz/docs/en/tools/shell#VPContent)

On this page

# Shell Tool ( `run_shell_command`) [​](https://gemini-cli.xyz/docs/en/tools/shell\#shell-tool-run-shell-command)

This document describes the `run_shell_command` tool for the Gemini CLI.

## Description [​](https://gemini-cli.xyz/docs/en/tools/shell\#description)
...
### Arguments [​](https://gemini-cli.xyz/docs/en/tools/shell\#arguments)
...
## How to use `run_shell_command` with the Gemini CLI [​](https://gemini-cli.xyz/docs/en/tools/shell\#how-to-use-run-shell-command-with-the-gemini-cli)
...
## `run_shell_command` examples [​](https://gemini-cli.xyz/docs/en/tools/shell\#run-shell-command-examples)
...
## Important notes [​](https://gemini-cli.xyz/docs/en/tools/shell\#important-notes)
...
## Environment Variables [​](https://gemini-cli.xyz/docs/en/tools/shell\#environment-variables)
...
## Command Restrictions [​](https://gemini-cli.xyz/docs/en/tools/shell\#command-restrictions)
...
### Command Restriction Examples [​](https://gemini-cli.xyz/docs/en/tools/shell\#command-restriction-examples)
...
## Security Note for `excludeTools` [​](https://gemini-cli.xyz/docs/en/tools/shell\#security-note-for-excludetools)
