[Skip to content](https://gemini-cli.xyz/docs/en/tools/multi-file#VPContent)

On this page

# Multi File Read Tool ( `read_many_files`) [​](https://gemini-cli.xyz/docs/en/tools/multi-file\#multi-file-read-tool-read-many-files)

This document describes the `read_many_files` tool for the Gemini CLI.

## Description [​](https://gemini-cli.xyz/docs/en/tools/multi-file\#description)
...
### Arguments [​](https://gemini-cli.xyz/docs/en/tools/multi-file\#arguments)
...
## How to use `read_many_files` with the Gemini CLI [​](https://gemini-cli.xyz/docs/en/tools/multi-file\#how-to-use-read-many-files-with-the-gemini-cli)
...
## `read_many_files` examples [​](https://gemini-cli.xyz/docs/en/tools/multi-file\#read-many-files-examples)
...
## Important notes [​](https://gemini-cli.xyz/docs/en/tools/multi-file\#important-notes)
