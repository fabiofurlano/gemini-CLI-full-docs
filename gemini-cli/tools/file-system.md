[Skip to content](https://gemini-cli.xyz/docs/en/tools/file-system#VPContent)

On this page

# Gemini CLI file system tools [​](https://gemini-cli.xyz/docs/en/tools/file-system\#gemini-cli-file-system-tools)
...
## 1\. `list_directory` (ReadFolder) [​](https://gemini-cli.xyz/docs/en/tools/file-system\#_1-list-directory-readfolder)
...
## 2\. `read_file` (ReadFile) [​](https://gemini-cli.xyz/docs/en/tools/file-system\#_2-read-file-readfile)
...
## 3\. `write_file` (WriteFile) [​](https://gemini-cli.xyz/docs/en/tools/file-system\#_3-write-file-writefile)
...
## 4\. `glob` (FindFiles) [​](https://gemini-cli.xyz/docs/en/tools/file-system\#_4-glob-findfiles)
...
## 5\. `search_file_content` (SearchText) [​](https://gemini-cli.xyz/docs/en/tools/file-system\#_5-search-file-content-searchtext)
...
## 6\. `replace` (Edit) [​](https://gemini-cli.xyz/docs/en/tools/file-system\#_6-replace-edit)
