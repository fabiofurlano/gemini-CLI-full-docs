[Skip to content](https://gemini-cli.xyz/docs/en/cli/configuration#VPContent)

On this page

# Gemini CLI Configuration [​](https://gemini-cli.xyz/docs/en/cli/configuration\#gemini-cli-configuration)

Gemini CLI offers several ways to configure its behavior, including environment variables, command-line arguments, and settings files. This document outlines the different configuration methods and available settings.

## Configuration layers [​](https://gemini-cli.xyz/docs/en/cli/configuration\#configuration-layers)
...
## Settings files [​](https://gemini-cli.xyz/docs/en/cli/configuration\#settings-files)
...
### The `.gemini` directory in your project [​](https://gemini-cli.xyz/docs/en/cli/configuration\#the-gemini-directory-in-your-project)

In addition to a project settings file, a project's `.gemini` directory can contain other project-specific files related to Gemini CLI's operation, such as:

- [Custom sandbox profiles](https://gemini-cli.xyz/docs/en/cli/configuration#sandboxing) (e.g., `.gemini/sandbox-macos-custom.sb`, `.gemini/sandbox.Dockerfile`).

### Available settings in `settings.json`: [​](https://gemini-cli.xyz/docs/en/cli/configuration\#available-settings-in-settings-json)
...
- **`theme`** (string):
  ...
  - **Description:** Sets the visual [theme](https://gemini-cli.xyz/docs/en/cli/themes) for Gemini CLI.
  - **Default:** `"Default"`
...
- **`sandbox`** (boolean or string):
  ...
  - **Description:** Controls whether and how to use sandboxing for tool execution. If set to `true`, Gemini CLI uses a pre-built `gemini-cli-sandbox` Docker image. For more information, see [Sandboxing](https://gemini-cli.xyz/docs/en/cli/configuration#sandboxing).
  - **Default:** `false`
...
- **`checkpointing`** (object):
  ...
  - **Description:** Configures the checkpointing feature, which allows you to save and restore conversation and file states. See the [Checkpointing documentation](https://gemini-cli.xyz/docs/en/checkpointing) for more details.
...
- **`telemetry`** (object)
  ...
  - **Description:** Configures logging and metrics collection for Gemini CLI. For more information, see [Telemetry](https://gemini-cli.xyz/docs/en/telemetry).
...
- **`usageStatisticsEnabled`** (boolean):
  ...
  - **Description:** Enables or disables the collection of usage statistics. See [Usage Statistics](https://gemini-cli.xyz/docs/en/cli/configuration#usage-statistics) for more information.
  - **Default:** `true`
  - **Example:**
    json
...
### Example `settings.json`: [​](https://gemini-cli.xyz/docs/en/cli/configuration\#example-settings-json)
...
## Shell History [​](https://gemini-cli.xyz/docs/en/cli/configuration\#shell-history)
...
## Environment Variables & `.env` Files [​](https://gemini-cli.xyz/docs/en/cli/configuration\#environment-variables-env-files)
...
## Command-Line Arguments [​](https://gemini-cli.xyz/docs/en/cli/configuration\#command-line-arguments)
...
- **`--telemetry`**:
  - Enables [telemetry](https://gemini-cli.xyz/docs/en/telemetry).
- **`--telemetry-target`**:
  - Sets the telemetry target. See [telemetry](https://gemini-cli.xyz/docs/en/telemetry) for more information.
- **`--telemetry-otlp-endpoint`**:
  - Sets the OTLP endpoint for telemetry. See [telemetry](https://gemini-cli.xyz/docs/en/telemetry) for more information.
- **`--telemetry-log-prompts`**:
  - Enables logging of prompts for telemetry. See [telemetry](https://gemini-cli.xyz/docs/en/telemetry) for more information.
- **`--checkpointing`**:
  - Enables [checkpointing](https://gemini-cli.xyz/docs/en/checkpointing).
...
## Context Files (Hierarchical Instructional Context) [​](https://gemini-cli.xyz/docs/en/cli/configuration\#context-files-hierarchical-instructional-context)
...
### Example Context File Content (e.g., `GEMINI.md`) [​](https://gemini-cli.xyz/docs/en/cli/configuration\#example-context-file-content-e-g-gemini-md)
...
- **Importing Content:** You can modularize your context files by importing other Markdown files using the `@path/to/file.md` syntax. For more details, see the [Memory Import Processor documentation](https://gemini-cli.xyz/docs/en/core/memport).
- **Commands for Memory Management:**
  - Use `/memory refresh` to force a re-scan and reload of all context files from all configured locations. This updates the AI's instructional context.
  - Use `/memory show` to display the combined instructional context currently loaded, allowing you to verify the hierarchy and content being used by the AI.
  - See the [Commands documentation](https://gemini-cli.xyz/docs/en/cli/commands#memory) for full details on the `/memory` command and its sub-commands ( `show` and `refresh`).

By understanding and utilizing these configuration layers and the hierarchical nature of context files, you can effectively manage the AI's memory and tailor the Gemini CLI's responses to your specific needs and projects.

## Sandboxing [​](https://gemini-cli.xyz/docs/en/cli/configuration\#sandboxing)
...
## Usage Statistics [​](https://gemini-cli.xyz/docs/en/cli/configuration\#usage-statistics)
